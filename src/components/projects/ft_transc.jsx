  ...
  return (
    <div className="w-full">
      {currentPathIndex < videoPaths.length && !useIframeEmbed ? (
        ...
        <div className="bg-blue-900/20 text-center py-8 rounded-lg mb-4">
          ...
          <div className="mt-4 space-y-2">
            {/* Quick fix options */}
            <button 
              onClick={() => window.open("https://github.com/Nkhou/ft_transcendence", "_blank")}
      ...
      <p className="text-gray-400 mb-4">
        A real-time multiplayer gaming platform with user authentication, live chat, matchmaking, and interactive gameplay.
      </p>
